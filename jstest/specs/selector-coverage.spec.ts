 ...
 * emitting data-gsxui-slot-dropdown-menu-menuitem while ui/dropdown-menu.js still binds
 * [data-gsxui-slot-dropdown-menu-item], dropdown is dead in production, every
