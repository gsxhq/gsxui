...
func TestComponents(t *testing.T) {
	...
	want := []string{"accordion", "alert", "avatar", "badge", "button", "card", "checkbox", "dialog", "dropdown", "icon", "input", "label", "radio", "selectbox", "separator", "skeleton", "switchctl", "table", "tabs", "textarea", "tooltip"}
