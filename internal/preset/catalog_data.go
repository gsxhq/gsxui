...
var baseColorCatalog = []baseColorDefinition{
	{
		name: "neutral", title: "Neutral", swatch: "oklch(0.205 0 0)",
		light: values(
	...
	{
		name: "stone", title: "Stone", swatch: "oklch(0.216 0.006 56.043)",
		light: values(
			"background", "oklch(1 0 0)",
	...
	{
		name: "zinc", title: "Zinc", swatch: "oklch(0.21 0.006 285.885)",
		light: values(
			"background", "oklch(1 0 0)",
	...
	{
		name: "mauve", title: "Mauve", swatch: "oklch(0.212 0.019 322.12)",
		light: values(
			"background", "oklch(1 0 0)",
	...
	{
		name: "olive", title: "Olive", swatch: "oklch(0.228 0.013 107.4)",
		light: values(
			"background", "oklch(1 0 0)",
	...
	{
		name: "mist", title: "Mist", swatch: "oklch(0.218 0.008 223.9)",
		light: values(
			"background", "oklch(1 0 0)",
	...
	{
		name: "taupe", title: "Taupe", swatch: "oklch(0.214 0.009 43.1)",
		light: values(
			"background", "oklch(1 0 0)",
...
var themeCatalog = []themeDefinition{
	{
		name: "neutral", title: "Neutral", swatch: "oklch(0.205 0 0)",
		light: values(
	...
	{
		name: "amber", title: "Amber", swatch: "oklch(0.555 0.163 48.998)",
		light: values(
	...
	{
		name: "blue", title: "Blue", swatch: "oklch(0.488 0.243 264.376)",
		light: values(
	...
	{
		name: "cyan", title: "Cyan", swatch: "oklch(0.52 0.105 223.128)",
		light: values(
	...
	{
		name: "emerald", title: "Emerald", swatch: "oklch(0.508 0.118 165.612)",
		light: values(
	...
	{
		name: "fuchsia", title: "Fuchsia", swatch: "oklch(0.518 0.253 323.949)",
		light: values(
	...
	{
		name: "green", title: "Green", swatch: "oklch(0.527 0.154 150.069)",
		light: values(
	...
	{
		name: "indigo", title: "Indigo", swatch: "oklch(0.457 0.24 277.023)",
		light: values(
	...
	{
		name: "lime", title: "Lime", swatch: "oklch(0.841 0.238 128.85)",
		light: values(
	...
	{
		name: "orange", title: "Orange", swatch: "oklch(0.553 0.195 38.402)",
		light: values(
	...
	{
		name: "pink", title: "Pink", swatch: "oklch(0.525 0.223 3.958)",
		light: values(
	...
	{
		name: "purple", title: "Purple", swatch: "oklch(0.496 0.265 301.924)",
		light: values(
	...
	{
		name: "red", title: "Red", swatch: "oklch(0.505 0.213 27.518)",
		light: values(
	...
	{
		name: "rose", title: "Rose", swatch: "oklch(0.514 0.222 16.935)",
		light: values(
	...
	{
		name: "sky", title: "Sky", swatch: "oklch(0.5 0.134 242.749)",
		light: values(
	...
	{
		name: "teal", title: "Teal", swatch: "oklch(0.511 0.096 186.391)",
		light: values(
	...
	{
		name: "violet", title: "Violet", swatch: "oklch(0.491 0.27 292.581)",
		light: values(
	...
	{
		name: "yellow", title: "Yellow", swatch: "oklch(0.852 0.199 91.936)",
		light: values(
