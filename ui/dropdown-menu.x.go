...
//line dropdown-menu.gsx:212:3
		...
		_gsxgw.S(">")
//line dropdown-menu.gsx:213:4
		_gsxgw.Node(ctx, icon.Circle())
		_gsxgw.S("</span>")
//line dropdown-menu.gsx:215:3
		_gsxgw.Node(ctx, children)
		_gsxgw.S("</div>")
		return _gsxgw.Err()
	})
...
//line dropdown-menu.gsx:225:1
func DropdownMenuSeparator(attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
//line dropdown-menu.gsx:226:2
		_gsxgw.S("<div")
		if !attrs.Has("role") {
