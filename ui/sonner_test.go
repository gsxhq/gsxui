...
func TestToastPinnedFull(t *testing.T) {
	...
	want := `<li data-slot="toast" data-gsxui-toast data-type="error" role="status" aria-live="assertive" aria-atomic="true" class="pointer-events-auto absolute bottom-6 right-6 flex w-[356px] items-start gap-3 rounded-2xl border border-border bg-popover p-4 text-sm text-popover-foreground shadow-lg origin-bottom transition-[transform,opacity] duration-300 ease-out data-[type=success]:[&amp;&gt;[data-icon]]:text-emerald-500 data-[type=info]:[&amp;&gt;[data-icon]]:text-sky-500 data-[type=warning]:[&amp;&gt;[data-icon]]:text-amber-500 data-[type=error]:[&amp;&gt;[data-icon]]:text-destructive"><div data-icon class="mt-0.5 shrink-0 [&amp;&gt;svg]:size-4"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-gsxui-slot="icon"><path d="m15 9-6 6"/><path d="M2.586 16.726A2 2 0 0 1 2 15.312V8.688a2 2 0 0 1 .586-1.414l4.688-4.688A2 2 0 0 1 8.688 2h6.624a2 2 0 0 1 1.414.586l4.688 4.688A2 2 0 0 1 22 8.688v6.624a2 2 0 0 1-.586 1.414l-4.688 4.688a2 2 0 0 1-1.414.586H8.688a2 2 0 0 1-1.414-.586z"/><path d="m9 9 6 6"/></svg></div><div data-content class="flex flex-1 flex-col gap-1"><div data-title class="font-medium text-foreground">Failed</div><div data-description class="text-muted-foreground">Try again</div></div><button type="button" data-action class="shrink-0 self-center text-sm font-medium underline-offset-4 hover:underline">Retry</button><button type="button" data-cancel class="shrink-0 self-center text-sm text-muted-foreground underline-offset-4 hover:underline">Dismiss</button><button type="button" data-close-button aria-label="Close" class="absolute -top-1.5 -right-1.5 flex size-5 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3" data-gsxui-slot="icon"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button></li>`
	if got != want {
		t.Errorf("pinned render mismatch\n got: %s\nwant: %s", got, want)
	}
}
...
func TestToastPinnedSuccess(t *testing.T) {
	...
	want := `<li data-slot="toast" data-gsxui-toast data-type="success" role="status" aria-live="polite" aria-atomic="true" class="pointer-events-auto absolute bottom-6 right-6 flex w-[356px] items-start gap-3 rounded-2xl border border-border bg-popover p-4 text-sm text-popover-foreground shadow-lg origin-bottom transition-[transform,opacity] duration-300 ease-out data-[type=success]:[&amp;&gt;[data-icon]]:text-emerald-500 data-[type=info]:[&amp;&gt;[data-icon]]:text-sky-500 data-[type=warning]:[&amp;&gt;[data-icon]]:text-amber-500 data-[type=error]:[&amp;&gt;[data-icon]]:text-destructive"><div data-icon class="mt-0.5 shrink-0 [&amp;&gt;svg]:size-4"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-gsxui-slot="icon"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg></div><div data-content class="flex flex-1 flex-col gap-1"><div data-title class="font-medium text-foreground">Changes saved</div><div data-description class="text-muted-foreground">Your settings are updated</div></div><button type="button" data-close-button aria-label="Close" class="absolute -top-1.5 -right-1.5 flex size-5 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3" data-gsxui-slot="icon"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button></li>`
	if got != want {
		t.Errorf("pinned render mismatch\n got: %s\nwant: %s", got, want)
	}
}
...
func TestToastPinnedDefault(t *testing.T) {
	...
	want := `<li data-slot="toast" data-gsxui-toast data-type="default" role="status" aria-live="polite" aria-atomic="true" class="pointer-events-auto absolute bottom-6 right-6 flex w-[356px] items-start gap-3 rounded-2xl border border-border bg-popover p-4 text-sm text-popover-foreground shadow-lg origin-bottom transition-[transform,opacity] duration-300 ease-out data-[type=success]:[&amp;&gt;[data-icon]]:text-emerald-500 data-[type=info]:[&amp;&gt;[data-icon]]:text-sky-500 data-[type=warning]:[&amp;&gt;[data-icon]]:text-amber-500 data-[type=error]:[&amp;&gt;[data-icon]]:text-destructive"><div data-content class="flex flex-1 flex-col gap-1"><div data-title class="font-medium text-foreground">Hello</div></div><button type="button" data-close-button aria-label="Close" class="absolute -top-1.5 -right-1.5 flex size-5 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3" data-gsxui-slot="icon"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button></li>`
	if got != want {
		t.Errorf("pinned render mismatch\n got: %s\nwant: %s", got, want)
	}
}
