...
//line field.gsx:46:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/field-group"), _gsxrt.Class("gap-5 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:58:2
		...
		_gsxv2 := "group/field"
		_gsxv3 := "data-[invalid=true]:text-destructive gap-2 p-2.5 flex"
		var _gsxv4 string
		switch orientation {
		case "horizontal":
...
//line field.gsx:100:3
			_gsxgw.Node(ctx, children)
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class("has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-lg has-[>[data-gsxui-slot-field]]:border flex"))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-field-label", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}
