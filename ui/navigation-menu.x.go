...
//line navigation-menu.gsx:254:2
		_gsxgw.S("<a")
		_gsxv0 := "data-active:focus:bg-muted data-active:hover:bg-muted data-active:bg-muted/50 focus-visible:ring-ring/50 hover:bg-muted focus:bg-muted flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 [[data-gsxui-slot-navigation-menu-content]_&]:rounded-md [&_svg:not([class*='size-'])]:size-4"
		var _gsxv1 string
		switch linkVariant {
		case "trigger":
