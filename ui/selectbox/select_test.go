...
import (
	...
	"github.com/gsxhq/gsxui/ui/selectbox"
)
...
func TestSelectDefault(t *testing.T) {
	got := render(t, selectbox.Select(gsx.Raw("<option>x</option>"), nil))
...
func TestSelectIconDependency(t *testing.T) {
	...
	// just imported.
	got := render(t, selectbox.Select(nil, nil))
...
func TestSelectCallerClassMerges(t *testing.T) {
	got := render(t, selectbox.Select(nil, gsx.Attrs{{Key: "class", Value: "w-full"}}))
	if strings.Contains(got, "w-fit") {
		t.Errorf("base w-fit should be dropped by caller w-full\nin: %s", got)
	}
...
func TestSelectAttrsFallThrough(t *testing.T) {
	got := render(t, selectbox.Select(nil, gsx.Attrs{{Key: "id", Value: "s1"}, {Key: "name", Value: "country"}, {Key: "aria-label", Value: "Country"}}))
...
func TestSelectOptionDefault(t *testing.T) {
	got := render(t, selectbox.SelectOption("us", false, false, gsx.Raw("United States"), nil))
...
func TestSelectOptionSelectedAttr(t *testing.T) {
	got := render(t, selectbox.SelectOption("us", true, false, gsx.Raw("United States"), nil))
...
func TestSelectOptionDisabledAttr(t *testing.T) {
	got := render(t, selectbox.SelectOption("us", false, true, gsx.Raw("United States"), nil))
...
func TestSelectOptionAttrsFallThrough(t *testing.T) {
	got := render(t, selectbox.SelectOption("us", false, false, gsx.Raw("US"), gsx.Attrs{{Key: "data-testid", Value: "opt-us"}}))
	if !strings.Contains(got, `data-testid="opt-us"`) {
		t.Errorf("missing fallthrough attr\nin: %s", got)
	}
}

func TestSelectGroupDefault(t *testing.T) {
	got := render(t, selectbox.SelectGroup("Countries", gsx.Raw("<option>US</option>"), nil))
...
func TestSelectGroupAttrsFallThrough(t *testing.T) {
	got := render(t, selectbox.SelectGroup("Countries", gsx.Raw("x"), gsx.Attrs{{Key: "id", Value: "g1"}}))
