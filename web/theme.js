...
if (preview) {
  ...
  // --- Export: theme.css owns semantic variables only. The project's
  // index.css keeps Tailwind, foundation, and the selected style imports. ---
  function buildCss() {
    ...
    const darkLines = VAR_ORDER.filter((name) => name !== "--radius")
      ...
      .join("\n");
    return `/* gsxui semantic theme variables. Generated by /theme. */
:root {
${rootLines}
}
