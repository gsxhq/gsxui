...
//line navigation-menu.gsx:48:2
	_gsxgw.S("<nav class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/navigation-menu"), _gsxrt.Class("max-w-max flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line navigation-menu.gsx:121:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/navigation-menu-trigger"), _gsxrt.Class("hover:bg-muted focus:bg-muted data-[state=open]:hover:bg-muted data-[state=open]:focus:bg-muted data-[state=open]:bg-muted/50 focus-visible:ring-ring/50 rounded-none px-2.5 py-1.5 text-xs font-medium transition-all focus-visible:ring-1 focus-visible:outline-1 disabled:opacity-50 inline-flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("type") {
...
//line navigation-menu.gsx:132:3
	_gsxgw.Node(ctx, children)
//line navigation-menu.gsx:132:15
	_gsxgw.Text(string(" "))
...
//line navigation-menu.gsx:142:1
...
//line navigation-menu.gsx:206:2
	...
	_gsxgw.S(">")
//line navigation-menu.gsx:216:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</div>")
	return _gsxgw.Err()
}

//line navigation-menu.gsx:220:1
...
//line navigation-menu.gsx:239:1
...
//line navigation-menu.gsx:250:2
	_gsxgw.S("<a")
	...
	_gsxgw.S(">")
//line navigation-menu.gsx:278:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</a>")
	return _gsxgw.Err()
}

//line navigation-menu.gsx:282:1
...
//line navigation-menu.gsx:309:1
...
//line navigation-menu.gsx:310:2
	_gsxgw.S("<div class=\"")
	...
	_gsxgw.S(">")
//line navigation-menu.gsx:318:3
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("bg-border rounded-none shadow-md"))
	_gsxgw.S("\"")
