...
component AccordionTrigger(children gsx.Node, attrs gsx.Attrs) {
	<summary
		class={
			"focus-visible:ring-ring/50 focus-visible:border-ring focus-visible:after:border-ring rounded-none py-2.5 text-left text-xs font-medium hover:underline focus-visible:ring-1 flex items-start outline-none transition-all border border-transparent"
		}
		{ attrs... }
...
component AccordionContent(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "text-xs overflow-hidden" } { attrs.Without("class")... } data-gsxui-slot-accordion-content>
