...
//line table.gsx:14:3
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("w-full caption-bottom text-xs"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line table.gsx:67:2
		...
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground mt-4 text-xs"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
