...
//line label.gsx:11:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs leading-none group-data-[disabled=true]:opacity-50 peer-disabled:opacity-50 flex items-center select-none group-data-[disabled=true]:pointer-events-none peer-disabled:cursor-not-allowed"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
