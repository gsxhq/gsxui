...
//line button.gsx:13:3
		...
		switch size {
		case "xs":
			_gsxv3 = "h-6 gap-1 rounded-none px-2 text-xs has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv3 = "h-7 gap-1 rounded-none px-2.5 has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3.5"
		case "lg":
...
//line button.gsx:59:3
		...
		switch size {
		case "xs":
			_gsxv7 = "h-6 gap-1 rounded-none px-2 text-xs has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv7 = "h-7 gap-1 rounded-none px-2.5 has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3.5"
		case "lg":
