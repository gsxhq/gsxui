...
//line toast.gsx:46:2
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("rounded-none flex w-[356px] items-start gap-3 border border-border bg-popover p-4 text-sm text-popover-foreground shadow-lg transition-[transform,opacity] duration-300 ease-out"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line toast.gsx:99:5
		...
		_gsxgw.S(">")
//line toast.gsx:99:78
		_gsxgw.Text(string(description))
		_gsxgw.S("</div>")
	}
	_gsxgw.S("</div>")
//line toast.gsx:102:3
	if action != "" {
//line toast.gsx:103:4
		...
		_gsxgw.S(">")
//line toast.gsx:108:5
		_gsxgw.Text(string(action))
		_gsxgw.S("</button>")
	}
//line toast.gsx:111:3
	if cancel != "" {
//line toast.gsx:112:4
		_gsxgw.S("<button type=\"button\" class=\"")
		...
		_gsxgw.S(">")
//line toast.gsx:117:5
		_gsxgw.Text(string(cancel))
		_gsxgw.S("</button>")
	}
//line toast.gsx:120:3
	_gsxgw.S("<button type=\"button\" class=\"")
	...
	_gsxgw.S("\" aria-label=\"")
	_gsxgw.AttrValue(string(i18n.T("Close")))
	_gsxgw.S("\"")
	_gsxgw.BoolAttr("data-gsxui-slot-toast-close", true)
	_gsxgw.S(">")
//line toast.gsx:128:4
