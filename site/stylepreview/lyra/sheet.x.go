...
//line sheet.gsx:59:4
		...
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("absolute top-3 end-3"))
		_gsxgw.S("\"")
...
//line sheet.gsx:90:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-0.5 p-4 flex flex-col"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line sheet.gsx:98:2
	_gsxgw.S("<h2 class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-foreground text-sm font-medium"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
	...
	_gsxgw.S(">")
//line sheet.gsx:104:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</h2>")
	return _gsxgw.Err()
}

//line sheet.gsx:108:1
