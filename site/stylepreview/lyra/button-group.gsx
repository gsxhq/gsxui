...
component ButtonGroup(orientation string, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={ "rounded-none flex", switch orientation { case "vertical": "flex-col" default: "flex-row" } }
		{ attrs... }
...
component ButtonGroupText(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={ "bg-muted gap-2 rounded-none border px-2.5 text-xs font-medium [&_svg:not([class*='size-'])]:size-4 flex" }
		{ attrs... }
