...
//line progress.gsx:44:2
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("relative flex w-full items-center overflow-x-hidden"), _gsxrt.Class("bg-muted h-1 rounded-none"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
