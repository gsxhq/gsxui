...
//line carousel.gsx:163:3
			_gsxgw.S("<span")
			_gsxgw.BoolAttr("data-gsxui-slot-carousel-control-label", true)
			_gsxgw.S(">Previous slide</span>")
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "data-gsxui-carousel-prev", Value: _gsxrt.Toggle(true)}}, _gsxa4, _gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(_gsxv2), _gsxrt.Class(_gsxv3))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-carousel-previous", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}

//line carousel.gsx:167:1
func CarouselNext(orientation string, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
//line carousel.gsx:168:2
...
//line carousel.gsx:186:3
			_gsxgw.S("<span")
			_gsxgw.BoolAttr("data-gsxui-slot-carousel-control-label", true)
			_gsxgw.S(">Next slide</span>")
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "data-gsxui-carousel-next", Value: _gsxrt.Toggle(true)}}, _gsxa7, _gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(_gsxv5), _gsxrt.Class(_gsxv6))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-carousel-next", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}
