...
//line menubar.gsx:169:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("items-center"), _gsxrt.Class("h-9 rounded-4xl border p-1 flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("role") {
...
//line menubar.gsx:207:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("items-center outline-hidden select-none"), _gsxrt.Class("hover:bg-muted aria-expanded:bg-muted rounded-xl px-2 py-0.75 text-sm font-medium flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("type") {
...
//line menubar.gsx:369:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("relative cursor-default items-center outline-hidden select-none [&_svg]:pointer-events-none [&_svg]:shrink-0"), _gsxrt.Class("data-disabled:pointer-events-none [&_svg:not([class*='text-'])]:text-muted-foreground focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground gap-2.5 rounded-xl py-2 pr-3 pl-9.5 text-sm data-inset:pl-9.5 [&_svg:not([class*='size-'])]:size-4 flex"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		if !attrs.Has("role") {
