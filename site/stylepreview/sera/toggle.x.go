...
//line toggle.gsx:59:2
	...
	switch size {
	case "sm":
		_gsxv2 = "h-9 min-w-9 px-4 has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3"
	case "lg":
		_gsxv2 = "h-11 min-w-11 px-8 has-data-[icon=inline-end]:pr-5 has-data-[icon=inline-start]:pl-5"
	default:
		_gsxv2 = "h-10 min-w-10 px-6 has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4"
	}
	_gsxgw.S(" class=\"")
