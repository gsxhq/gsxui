...
component AlertDialogTitle(children gsx.Node, attrs gsx.Attrs) {
	<h2
		class={ "text-lg font-semibold uppercase tracking-wider" }
		{ attrs... }
...
component AlertDialogDescription(children gsx.Node, attrs gsx.Attrs) {
	<p
		class={
			"text-muted-foreground *:[a]:hover:text-foreground text-sm text-balance md:text-pretty *:[a]:underline *:[a]:underline-offset-3 leading-relaxed mt-0.5"
		}
		{ attrs... }
