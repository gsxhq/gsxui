...
//line menubar.gsx:169:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("items-center"), _gsxrt.Class("h-10 rounded-none border p-1 flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("role") {
...
//line menubar.gsx:207:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("items-center outline-hidden select-none"), _gsxrt.Class("hover:bg-muted aria-expanded:bg-muted rounded-none px-2 py-0.75 text-sm font-medium flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("type") {
...
//line menubar.gsx:487:2
		...
		_gsxgw.S(">")
//line menubar.gsx:500:3
		_gsxgw.Node(ctx, children)
//line menubar.gsx:501:3
