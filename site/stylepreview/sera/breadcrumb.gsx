...
component BreadcrumbList(children gsx.Node, attrs gsx.Attrs) {
	<ol
		class={
			"text-muted-foreground gap-1.5 text-xs uppercase tracking-wide sm:gap-2.5 flex flex-wrap items-center wrap-break-word"
		}
		{ attrs... }
...
component BreadcrumbItem(children gsx.Node, attrs gsx.Attrs) {
	<li class={ "gap-1.5 inline-flex items-center" } { attrs... } data-gsxui-slot-breadcrumb-item>
		{ children }
	</li>
}
