...
//line calendar.gsx:702:2
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("p-3 [--cell-radius:0] [--cell-size:--spacing(8)]"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line calendar.gsx:773:4
	...
	_gsxgw.S(">")
//line calendar.gsx:777:5
	if dropdownLayout {
//line calendar.gsx:778:6
		_gsxgw.S("<div class=\"")
...
//line calendar.gsx:793:7
		_gsxgw.NodeResult(_gsxrenderNativeSelect(ctx, _gsxgw, _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
			_gsxgw := _gsxrt.W(_gsxw)
//line calendar.gsx:794:8
...
//line calendar.gsx:934:3
	if showHiddenSingle {
//line calendar.gsx:935:4
...
//line calendar.gsx:937:3
	if showHiddenMultiple {
//line calendar.gsx:938:4
		for _, value := range multipleHiddenValues {
//line calendar.gsx:939:5
			_gsxgw.S("<input type=\"hidden\" name=\"")
			_gsxgw.AttrValue(string(name))
			_gsxgw.S("\" value=\"")
...
//line calendar.gsx:942:3
	if showHiddenFrom {
//line calendar.gsx:943:4
		_gsxgw.S("<input type=\"hidden\" name=\"")
		_gsxgw.AttrValue(string(name))
		_gsxgw.S("\" value=\"")
...
//line calendar.gsx:945:3
	if showHiddenTo {
//line calendar.gsx:946:4
		_gsxgw.S("<input type=\"hidden\" name=\"")
