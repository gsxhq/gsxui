...
//line table.gsx:45:2
	_gsxgw.S("<th class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground h-12 px-3 text-left align-middle text-xs font-medium uppercase tracking-wider whitespace-nowrap [&:has([role=checkbox])]:pr-0"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line table.gsx:57:2
	_gsxgw.S("<td class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("p-3 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
