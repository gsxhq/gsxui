...
//line drawer.gsx:57:4
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("bg-muted mx-auto mt-4 hidden h-1.5 w-[100px] shrink-0 rounded-none"))
		_gsxgw.S("\"")
...
//line drawer.gsx:67:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-1 p-4 md:gap-2 md:text-left flex flex-col"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line drawer.gsx:88:2
	_gsxgw.S("<p class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground text-sm leading-relaxed mt-0.5 text-balance"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
