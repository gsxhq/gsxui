...
//line toggle-group.gsx:75:2
	...
	_gsxv1 := "data-[spacing=0]:data-[variant=outline]:rounded-none flex w-fit items-center gap-[--spacing(var(--gap))]"
	var _gsxv2 string
	switch size {
	case "sm":
...
//line toggle-group.gsx:120:2
	...
	switch size {
	case "sm":
		_gsxv4 = "h-9 min-w-9 px-4 has-[>svg]:px-3 group-data-[spacing=0]/toggle-group:has-[>svg]:px-3"
	case "lg":
		_gsxv4 = "h-11 min-w-11 px-8 has-[>svg]:px-5 group-data-[spacing=0]/toggle-group:has-[>svg]:px-5"
	default:
		_gsxv4 = "h-10 min-w-10 px-6 has-[>svg]:px-4 group-data-[spacing=0]/toggle-group:has-[>svg]:px-4"
	}
	var _gsxv5 string
	switch sp {
	case "2":
