...
//line input-group.gsx:44:2
	...
	_gsxv0 := "text-muted-foreground [&_[data-gsxui-slot-kbd]]:bg-muted-foreground/10 h-auto gap-2 py-2 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 [&_[data-gsxui-slot-kbd]]:rounded-none [&_[data-gsxui-slot-kbd]]:px-1.5 [&>svg:not([class*='size-'])]:size-3.5 flex"
	var _gsxv1 string
	switch align {
	case "inline-end":
		_gsxv1 = "order-last pe-2"
	case "block-start":
		_gsxv1 = "pt-3 group-has-[>input]/input-group:pt-3.5 [.border-b]:pb-3.5"
	case "block-end":
		_gsxv1 = "pb-3 group-has-[>input]/input-group:pb-3.5 [.border-t]:pt-3.5"
	default:
...
//line input-group.gsx:84:2
		_gsxgw.S("<span class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground gap-2 text-sm [&_svg:not([class*='size-'])]:size-3.5 flex"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
