...
//line button.gsx:13:3
		...
		case "outline":
			_gsxv2 = "border-border bg-transparent hover:bg-muted hover:text-foreground dark:hover:bg-input/30 aria-expanded:bg-muted aria-expanded:text-foreground"
		case "secondary":
		...
		case "link":
			_gsxv2 = "text-primary underline-offset-4 hover:underline underline"
		default:
		...
		switch size {
		case "xs":
			_gsxv3 = "h-7 gap-1 px-3 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv3 = "h-9 gap-1 px-4 has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3"
		case "lg":
			_gsxv3 = "h-11 gap-1.5 px-8 has-data-[icon=inline-end]:pr-5 has-data-[icon=inline-start]:pl-5"
		case "icon":
			_gsxv3 = "size-10"
		case "icon-xs":
			_gsxv3 = "size-7 [&_svg:not([class*='size-'])]:size-3"
		case "icon-sm":
			_gsxv3 = "size-9"
		case "icon-lg":
			_gsxv3 = "size-11"
		default:
			_gsxv3 = "h-10 gap-1.5 px-6 has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4"
		}
		_gsxgw.S(" class=\"")
...
//line button.gsx:59:3
		...
		_gsxv4 := "group/button"
		_gsxv5 := "focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-none border border-transparent bg-clip-padding text-xs font-semibold uppercase tracking-widest focus-visible:ring-2 aria-invalid:ring-2 active:not-aria-[haspopup]:translate-y-px [&_svg:not([class*='size-'])]:size-3.5 inline-flex shrink-0 items-center justify-center whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0"
		var _gsxv6 string
		switch variant {
		case "destructive":
		...
		case "outline":
			_gsxv6 = "border-border bg-transparent hover:bg-muted hover:text-foreground dark:hover:bg-input/30 aria-expanded:bg-muted aria-expanded:text-foreground"
		case "secondary":
		...
		case "link":
			_gsxv6 = "text-primary underline-offset-4 hover:underline underline"
		default:
		...
		case "sm":
			_gsxv7 = "h-9 gap-1 px-4 has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3"
		case "lg":
			_gsxv7 = "h-11 gap-1.5 px-8 has-data-[icon=inline-end]:pr-5 has-data-[icon=inline-start]:pl-5"
		case "icon":
			_gsxv7 = "size-10"
		case "icon-xs":
			_gsxv7 = "size-7 [&_svg:not([class*='size-'])]:size-3"
		case "icon-sm":
			_gsxv7 = "size-9"
		case "icon-lg":
			_gsxv7 = "size-11"
		default:
			_gsxv7 = "h-10 gap-1.5 px-6 has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4"
		}
		_gsxgw.S(" class=\"")
