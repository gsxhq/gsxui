...
component FieldGroup(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={ "group/field-group", "gap-7 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col" }
		{ attrs... }
...
component Field(orientation string, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={
			"group/field",
			"data-[invalid=true]:text-destructive gap-3 p-3 flex",
			switch orientation {
			case "horizontal":
...
component FieldLabel(children gsx.Node, attrs gsx.Attrs) {
	<Label
		class={
			"has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border flex"
		}
		{ attrs... }
...
component FieldTitle(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={ "gap-2 text-sm font-medium flex leading-snug" }
		{ attrs... }
