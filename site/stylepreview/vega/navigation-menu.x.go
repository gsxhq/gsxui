...
//line navigation-menu.gsx:121:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/navigation-menu-trigger"), _gsxrt.Class("hover:bg-muted focus:bg-muted data-[state=open]:hover:bg-muted data-[state=open]:focus:bg-muted data-[state=open]:bg-muted/50 focus-visible:ring-ring/50 rounded-md px-4 py-2 text-sm font-medium transition-all focus-visible:ring-3 focus-visible:outline-1 disabled:opacity-50 inline-flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	if !attrs.Has("type") {
