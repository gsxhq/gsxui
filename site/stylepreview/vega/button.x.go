...
//line button.gsx:13:3
		...
		switch size {
		case "xs":
			_gsxv3 = "h-6 gap-1 rounded-[min(var(--radius-md),8px)] px-2 text-xs has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv3 = "h-8 gap-1 rounded-[min(var(--radius-md),10px)] px-2.5 has-[>svg]:px-1.5"
		case "lg":
			_gsxv3 = "h-10 gap-1.5 px-2.5 has-[>svg]:px-2"
		case "icon":
			_gsxv3 = "size-9"
		case "icon-xs":
...
//line button.gsx:59:3
		...
		switch size {
		case "xs":
			_gsxv7 = "h-6 gap-1 rounded-[min(var(--radius-md),8px)] px-2 text-xs has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv7 = "h-8 gap-1 rounded-[min(var(--radius-md),10px)] px-2.5 has-[>svg]:px-1.5"
		case "lg":
			_gsxv7 = "h-10 gap-1.5 px-2.5 has-[>svg]:px-2"
		case "icon":
			_gsxv7 = "size-9"
		case "icon-xs":
