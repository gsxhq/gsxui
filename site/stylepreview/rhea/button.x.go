...
//line button.gsx:13:3
		...
		case "sm":
			_gsxv3 = "h-7 gap-1 px-3 has-[>svg]:px-2"
		case "lg":
			_gsxv3 = "h-9 gap-1.5 px-4 has-[>svg]:px-3"
		case "icon":
			_gsxv3 = "size-8"
		case "icon-xs":
		...
		case "icon-lg":
			_gsxv3 = "size-9"
		default:
			_gsxv3 = "h-8 gap-1.5 px-3 has-[>svg]:px-2.5"
		}
		_gsxgw.S(" class=\"")
...
//line button.gsx:59:3
		...
		case "sm":
			_gsxv7 = "h-7 gap-1 px-3 has-[>svg]:px-2"
		case "lg":
			_gsxv7 = "h-9 gap-1.5 px-4 has-[>svg]:px-3"
		case "icon":
			_gsxv7 = "size-8"
		case "icon-xs":
		...
		case "icon-lg":
			_gsxv7 = "size-9"
		default:
			_gsxv7 = "h-8 gap-1.5 px-3 has-[>svg]:px-2.5"
		}
		_gsxgw.S(" class=\"")
