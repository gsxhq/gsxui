...
//line card.gsx:56:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("rounded-b-[min(var(--radius-4xl),24px)] px-(--card-spacing) flex items-center [.border-t]:pt-(--card-spacing)"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
