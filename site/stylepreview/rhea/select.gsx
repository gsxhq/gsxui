...
component SelectLabel(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "text-muted-foreground px-2 py-1 text-xs" } { attrs... } data-gsxui-slot-select-label>{ children }</div>
}
