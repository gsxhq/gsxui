...
//line calendar.gsx:804:2
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("p-3 [--cell-radius:var(--radius-2xl)] [--cell-size:--spacing(8)] w-fit bg-background [[data-gsxui-slot-card-content]_&]:bg-transparent [[data-gsxui-slot-popover-content]_&]:bg-transparent"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
