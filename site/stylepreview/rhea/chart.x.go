...
/*line chart.gsx:17:1*/ // ChartConfig is the pendant of shadcn's ChartConfig: label and color per
...
func (c ChartConfig) styleSchemes() []chartStyleScheme {
	...
	for _, scheme := range []struct{ Name, Prefix string }{{"light", ""}, {"dark", ".dark "}} {
		...
		for _, s := range c {
			...
			if color != "" {
				decls += _gsxrt.RawCSS("--color-" + _gsxrt.FilterCSS(string(s.Key)) + ": " + string(color) + ";") /*line chart.gsx:107:46*/
			}
		}
...
func chartStyleRules(id string, schemes []chartStyleScheme) gsx.RawCSS {
	...
	for _, sc := range schemes {
		out += _gsxrt.RawCSS(string(gsx.RawCSS(sc.prefix)) + "[data-chart=" + string(gsx.RawCSS(id)) + "]{" + string(sc.decls) + "}") /*line chart.gsx:123:82*/
	}
	return out
}
...
//line chart.gsx:1483:3
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("flex items-center justify-center gap-4"), _gsxrt.ClassIf("pt-3", !top), _gsxrt.ClassIf("pb-3", top), _gsxrt.Class(opts.Class))
		_gsxgw.S("\">")
//line chart.gsx:1484:4
		for _, it := range items {
//line chart.gsx:1485:5
			_gsxgw.S("<div class=\"flex items-center gap-1.5 [&amp;&gt;svg]:h-3 [&amp;&gt;svg]:w-3 [&amp;&gt;svg]:text-muted-foreground\">")
//line chart.gsx:1486:6
			if it.icon != nil && !opts.HideIcon {
//line chart.gsx:1487:7
				_gsxgw.Node(ctx, it.icon)
			} else {
//line chart.gsx:1489:7
				_gsxgw.S("<div class=\"h-2 w-2 shrink-0 rounded-[2px]\" style=\"background-color:")
				_gsxgw.AttrValue(_gsxrt.StyleValue(it.color))
				_gsxgw.S("\"></div>")
			}
//line chart.gsx:1491:6
...
//line chart.gsx:1573:3
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("bg-popover text-popover-foreground ring-foreground/5 dark:ring-foreground/10 gap-1.5 rounded-xl px-2.5 py-1.5 text-xs shadow-lg ring-1 grid min-w-32 items-start"))
		_gsxgw.S("\"")
...
func BarChart(data []ChartDatum, marginTop float64, marginRight float64, marginBottom float64, marginLeft float64, children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBarChart(ctx, _gsxgw, data, marginTop, marginRight, marginBottom, marginLeft, children, attrs)
	})
}

func _gsxrenderBarChart(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, data []ChartDatum, marginTop float64, marginRight float64, marginBottom float64, marginLeft float64, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1620:2
...
//line chart.gsx:1623:1
// LineChart is the Recharts LineChart root.

//line chart.gsx:1624:1
...
func AreaChart(data []ChartDatum, marginTop float64, marginRight float64, marginBottom float64, marginLeft float64, stackOffset string, children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderAreaChart(ctx, _gsxgw, data, marginTop, marginRight, marginBottom, marginLeft, stackOffset, children, attrs)
	})
}

func _gsxrenderAreaChart(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, data []ChartDatum, marginTop float64, marginRight float64, marginBottom float64, marginLeft float64, stackOffset string, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1631:2
...
//line chart.gsx:1634:1
// RadarChart is the Recharts RadarChart root.

//line chart.gsx:1635:1
...
//line chart.gsx:1676:1
func ChartCartesianGrid(horizontal bool, vertical bool) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartCartesianGrid(ctx, _gsxgw, horizontal, vertical)
	})
}

func _gsxrenderChartCartesianGrid(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, horizontal bool, vertical bool) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1677:2
...
func ChartXAxis(key string, hide bool, tickLine bool, axisLine bool, tickMargin float64, minTickGap float64) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartXAxis(ctx, _gsxgw, key, hide, tickLine, axisLine, tickMargin, minTickGap)
	})
}

func _gsxrenderChartXAxis(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, key string, hide bool, tickLine bool, axisLine bool, tickMargin float64, minTickGap float64) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1686:2
	if st := chartStateFromCtx(ctx); st != nil {
...
func ChartTooltip(cursor bool, indicator string, labelKey string, hideLabel bool, hideIndicator bool, nameKey string, class string, labelClass string, color string, hasDefaultIndex bool, defaultIndex int) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartTooltip(ctx, _gsxgw, cursor, indicator, labelKey, hideLabel, hideIndicator, nameKey, class, labelClass, color, hasDefaultIndex, defaultIndex)
	})
}

func _gsxrenderChartTooltip(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, cursor bool, indicator string, labelKey string, hideLabel bool, hideIndicator bool, nameKey string, class string, labelClass string, color string, hasDefaultIndex bool, defaultIndex int) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1726:2
	var di *int
	if hasDefaultIndex {
		di = &defaultIndex
	}
...
//line chart.gsx:1743:1
func ChartLegend(nameKey string, class string, verticalAlign string, hideIcon bool) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartLegend(ctx, _gsxgw, nameKey, class, verticalAlign, hideIcon)
	})
}

func _gsxrenderChartLegend(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, nameKey string, class string, verticalAlign string, hideIcon bool) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1744:2
	if st := chartStateFromCtx(ctx); st != nil {
...
//line chart.gsx:1787:1
func ChartArea(key string, curve string, fill string, stroke string, stackId string, fillOpacity float64) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartArea(ctx, _gsxgw, key, curve, fill, stroke, stackId, fillOpacity)
	})
}

func _gsxrenderChartArea(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, key string, curve string, fill string, stroke string, stackId string, fillOpacity float64) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1788:2
	if st := chartStateFromCtx(ctx); st != nil {
...
//line chart.gsx:1800:1
func ChartBar(key string, fill string, stackId string, radius any, strokeWidth float64) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderChartBar(ctx, _gsxgw, key, fill, stackId, radius, strokeWidth)
	})
}

func _gsxrenderChartBar(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, key string, fill string, stackId string, radius any, strokeWidth float64) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line chart.gsx:1801:2
	if st := chartStateFromCtx(ctx); st != nil {
