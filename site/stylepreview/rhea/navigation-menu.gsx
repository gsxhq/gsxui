...
component NavigationMenuLink(active bool, variant string, children gsx.Node, attrs gsx.Attrs) {
	...
	<a
		class={
			"focus-visible:ring-ring/30 hover:bg-muted focus:bg-muted flex items-center gap-2 rounded-2xl px-2.5 py-1.5 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 [[data-gsxui-slot-navigation-menu-content]_&]:rounded-xl font-medium [[data-gsxui-slot-navigation-menu-content]_&]:font-normal [[data-gsxui-slot-navigation-menu-content]_&]:p-2 [[data-gsxui-slot-navigation-menu-content]_&]:w-full",
			switch linkVariant {
			case "trigger":
