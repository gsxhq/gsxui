...
//line breadcrumb.gsx:20:1
func Breadcrumb(children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumb(ctx, _gsxgw, children, attrs)
	})
}

func _gsxrenderBreadcrumb(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:21:2
	_gsxgw.S("<nav")
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:21:71
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</nav>")
	return _gsxgw.Err()
}

//line breadcrumb.gsx:24:1
func BreadcrumbList(children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbList(ctx, _gsxgw, children, attrs)
	})
}

func _gsxrenderBreadcrumbList(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:25:2
	_gsxgw.S("<ol class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground gap-1.5 text-xs/relaxed flex flex-wrap items-center wrap-break-word"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:30:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</ol>")
	return _gsxgw.Err()
}

//line breadcrumb.gsx:34:1
func BreadcrumbItem(children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbItem(ctx, _gsxgw, children, attrs)
	})
}

func _gsxrenderBreadcrumbItem(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:35:2
	_gsxgw.S("<li class=\"")
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:36:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</li>")
	return _gsxgw.Err()
}

//line breadcrumb.gsx:40:1
...
//line breadcrumb.gsx:47:1
func BreadcrumbLink(href string, children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbLink(ctx, _gsxgw, href, children, attrs)
	})
}

func _gsxrenderBreadcrumbLink(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, href string, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:48:2
	_gsxgw.S("<a")
	if !attrs.Has("href") {
		_gsxgw.S(" href=\"")
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("hover:text-foreground transition-colors"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:49:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</a>")
	return _gsxgw.Err()
}

//line breadcrumb.gsx:53:1
func BreadcrumbPage(children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbPage(ctx, _gsxgw, children, attrs)
	})
}

func _gsxrenderBreadcrumbPage(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:54:2
	_gsxgw.S("<span")
	if !attrs.Has("role") {
		_gsxgw.S(" role=\"link\"")
	}
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-foreground font-normal"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:62:3
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</span>")
	return _gsxgw.Err()
}

//line breadcrumb.gsx:66:1
...
//line breadcrumb.gsx:69:1
func BreadcrumbSeparator(children gsx.Node, attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbSeparator(ctx, _gsxgw, children, attrs)
	})
}

func _gsxrenderBreadcrumbSeparator(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, children gsx.Node, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:70:2
	_gsxgw.S("<li")
	if !attrs.Has("role") {
	...
	_gsxgw.S(">")
//line breadcrumb.gsx:77:3
	if children != nil {
//line breadcrumb.gsx:78:4
		_gsxgw.Node(ctx, children)
	} else {
//line breadcrumb.gsx:80:4
...
//line breadcrumb.gsx:88:1
func BreadcrumbEllipsis(attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
		return _gsxrenderBreadcrumbEllipsis(ctx, _gsxgw, attrs)
	})
}

func _gsxrenderBreadcrumbEllipsis(ctx _gsxctx.Context, _gsxgw *_gsxrt.Writer, attrs gsx.Attrs) error {
	if _gsxerr := _gsxgw.Err(); _gsxerr != nil {
		return _gsxerr
	}
//line breadcrumb.gsx:89:2
	_gsxgw.S("<span")
	if !attrs.Has("role") {
		_gsxgw.S(" role=\"presentation\"")
	}
	...
	_gsxgw.S(" class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("size-4 [&>svg]:size-3.5 flex items-center justify-center"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line breadcrumb.gsx:97:3
	_gsxgw.S("<span")
	_gsxgw.BoolAttr("data-gsxui-slot-breadcrumb-ellipsis-label", true)
	_gsxgw.S(">")
//line breadcrumb.gsx:97:51
	_gsxgw.Text(string(i18n.T("More")))
	_gsxgw.S("</span></span>")
	return _gsxgw.Err()
}
