...
//line field.gsx:46:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/field-group"), _gsxrt.Class("gap-4 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:58:2
	...
	_gsxv2 := "group/field"
	_gsxv3 := "data-[invalid=true]:text-destructive gap-2 p-2 flex"
	var _gsxv4 string
	switch orientation {
	case "horizontal":
...
//line field.gsx:100:3
		_gsxgw.Node(ctx, children)
		return _gsxgw.Err()
	}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class("has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border flex"))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-field-label", Value: _gsxrt.Toggle(true)}})))
	return _gsxgw.Err()
}
...
//line field.gsx:107:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed font-medium flex"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:117:2
	_gsxgw.S("<p class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground text-left text-xs/relaxed [[data-variant=legend]+&]:-mt-1.5"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
