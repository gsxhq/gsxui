...
//line native-select.gsx:40:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("[&>svg]:text-muted-foreground [&>svg]:top-1/2 [&>svg]:right-1.5 [&>svg]:size-3.5 [&>svg]:-translate-y-1/2 group-data-[size=sm]/native-select:[&>svg]:size-3 group-data-[size=sm]/native-select:[&>svg]:-translate-y-[calc(--spacing(1.25))]"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line native-select.gsx:47:3
	...
	_gsxgw.S(">")
//line native-select.gsx:54:4
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</select>")
//line native-select.gsx:56:3
	_gsxgw.Node(ctx, icon.ChevronDown())
	_gsxgw.S("</div>")
	return _gsxgw.Err()
}

//line native-select.gsx:60:1
...
//line native-select.gsx:66:2
	...
	_gsxgw.S(">")
//line native-select.gsx:66:77
	_gsxgw.Node(ctx, children)
	_gsxgw.S("</option>")
	return _gsxgw.Err()
}

//line native-select.gsx:69:1
