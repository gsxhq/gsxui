...
//line native-select.gsx:40:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/native-select"), _gsxrt.Class("relative w-fit [&>svg]:pointer-events-none [&>svg]:absolute [&>svg]:opacity-50 [&>svg]:text-muted-foreground [&>svg]:top-1/2 [&>svg]:right-1.5 [&>svg]:size-3.5 [&>svg]:-translate-y-1/2 group-data-[size=sm]/native-select:[&>svg]:size-3 group-data-[size=sm]/native-select:[&>svg]:-translate-y-[calc(--spacing(1.25))] has-[select:disabled]:opacity-50"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line native-select.gsx:48:3
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("border-input bg-input/20 placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 dark:hover:bg-input/50 focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 h-7 w-full min-w-0 appearance-none rounded-md border py-0.5 pr-6 pl-2 text-xs/relaxed transition-colors select-none focus-visible:ring-2 aria-invalid:ring-2 data-[size=sm]:h-6 data-[size=sm]:text-[0.625rem] outline-none disabled:pointer-events-none disabled:cursor-not-allowed"), _gsxrt.Class(_gsxv0.Class()))
	_gsxgw.S("\"")
