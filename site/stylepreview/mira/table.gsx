...
component Table(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "relative w-full overflow-x-auto" } data-gsxui-slot-table-container>
		<table class={ "w-full caption-bottom text-xs" } { attrs... } data-gsxui-slot-table>{ children }</table>
	</div>
}
...
component TableCaption(children gsx.Node, attrs gsx.Attrs) {
	<caption class={ "text-muted-foreground mt-4 text-xs" } { attrs... } data-gsxui-slot-table-caption>
		{ children }
	</caption>
}
