...
//line empty.gsx:10:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 rounded-xl border-dashed p-6 flex flex-col w-full min-w-0 flex-1 items-center justify-center text-center text-balance"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
...
//line empty.gsx:22:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-1 flex flex-col max-w-sm items-center text-center"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
...
//line empty.gsx:32:2
	...
	switch variant {
	case "icon":
		_gsxv1 = "bg-muted text-foreground flex size-8 shrink-0 items-center justify-center rounded-md [&_svg:not([class*='size-'])]:size-4"
	default:
...
//line empty.gsx:72:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed flex flex-col w-full max-w-sm min-w-0 items-center text-balance"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
