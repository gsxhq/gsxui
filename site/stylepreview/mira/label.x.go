...
//line label.gsx:11:2
	...
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed leading-none font-medium group-data-[disabled=true]:opacity-50 peer-disabled:opacity-50 flex"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
