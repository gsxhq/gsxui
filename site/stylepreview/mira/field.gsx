...
component FieldGroup(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={ "gap-4 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col" }
		{ attrs... }
...
component Field(orientation string, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={
			"data-[invalid=true]:text-destructive gap-2 p-2 flex",
			switch orientation {
			case "horizontal":
...
component FieldLabel(children gsx.Node, attrs gsx.Attrs) {
	<Label
		class={
			"has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10 gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border flex"
		}
		{ attrs... }
...
component FieldTitle(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={ "gap-2 text-xs/relaxed font-medium group-data-[disabled=true]/field:opacity-50 flex" }
		{ attrs... }
...
component FieldDescription(children gsx.Node, attrs gsx.Attrs) {
	<p
		class={ "text-muted-foreground text-left text-xs/relaxed [[data-variant=legend]+&]:-mt-1.5" }
		{ attrs... }
