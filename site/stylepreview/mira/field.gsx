...
component FieldLabel(children gsx.Node, attrs gsx.Attrs) {
	<Label
		class={
			"has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border flex w-fit has-[>[data-gsxui-slot-field]]:w-full has-[>[data-gsxui-slot-field]]:flex-col [&>[data-gsxui-slot-field]]:p-2"
		}
		{ attrs... }
