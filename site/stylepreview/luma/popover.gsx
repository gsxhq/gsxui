...
component PopoverContent(children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		tabindex="-1"
		class={
			"transition-none bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 ring-foreground/5 dark:ring-foreground/10 [&:popover-open]:flex flex-col gap-4 rounded-3xl p-4 text-sm shadow-lg ring-1 duration-100 w-72 origin-top outline-hidden"
		}
		{ attrs... }
