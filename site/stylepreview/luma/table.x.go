...
//line table.gsx:45:2
	_gsxgw.S("<th class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-foreground h-12 px-3 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
	_gsxgw.StyleMerged("", attrs.Style())
