...
//line button.gsx:13:3
		...
		switch size {
		case "xs":
			_gsxv3 = "h-6 gap-1 px-2.5 text-xs has-[>svg]:px-2 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv3 = "h-8 gap-1 px-3 has-[>svg]:px-2"
		case "lg":
			_gsxv3 = "h-10 gap-1.5 px-4 has-[>svg]:px-3"
		case "icon":
			_gsxv3 = "size-9"
		case "icon-xs":
		...
		case "icon-lg":
			_gsxv3 = "size-10"
		default:
			_gsxv3 = "h-9 gap-1.5 px-3 has-[>svg]:px-2.5"
		}
		_gsxgw.S(" class=\"")
...
//line button.gsx:59:3
		...
		switch size {
		case "xs":
			_gsxv7 = "h-6 gap-1 px-2.5 text-xs has-[>svg]:px-2 [&_svg:not([class*='size-'])]:size-3"
		case "sm":
			_gsxv7 = "h-8 gap-1 px-3 has-[>svg]:px-2"
		case "lg":
			_gsxv7 = "h-10 gap-1.5 px-4 has-[>svg]:px-3"
		case "icon":
			_gsxv7 = "size-9"
		case "icon-xs":
		...
		case "icon-lg":
			_gsxv7 = "size-10"
		default:
			_gsxv7 = "h-9 gap-1.5 px-3 has-[>svg]:px-2.5"
		}
		_gsxgw.S(" class=\"")
