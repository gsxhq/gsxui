...
component ToggleGroup(groupType string, variant string, size string, spacing string, children gsx.Node, attrs gsx.Attrs) {
	...
	<div
		...
		class={
			"group/toggle-group",
			"data-[spacing=0]:data-[variant=outline]:rounded-3xl flex w-fit items-center gap-[--spacing(var(--gap))]",
