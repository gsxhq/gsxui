...
//line tooltip.gsx:28:3
	_gsxgw.S("<span class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-[2px] bg-foreground top-full start-1/2 -translate-x-1/2 rtl:translate-x-1/2"))
	_gsxgw.S("\"")
