...
//line navigation-menu.gsx:125:2
		...
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/navigation-menu-trigger"), _gsxrt.Class("hover:bg-muted focus:bg-muted data-[state=open]:hover:bg-muted data-[state=open]:focus:bg-muted data-[state=open]:bg-muted/50 focus-visible:ring-ring/50 rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all focus-visible:ring-3 focus-visible:outline-1 disabled:opacity-50 inline-flex h-9 w-max items-center justify-center outline-none disabled:pointer-events-none"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		if !attrs.Has("type") {
...
//line navigation-menu.gsx:137:3
		_gsxgw.Node(ctx, icon.ChevronDown(_gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class("relative top-px ms-1 size-3 transition duration-300 group-data-[state=open]/navigation-menu-trigger:rotate-180"))}}, _gsxrt.Attrs{{Key: "data-gsxui-slot-navigation-menu-trigger-icon", Value: _gsxrt.Toggle(true)}})...))
		_gsxgw.S("</button>")
		return _gsxgw.Err()
	})
}
...
//line navigation-menu.gsx:254:2
		...
		_gsxgw.S(">")
//line navigation-menu.gsx:282:3
		_gsxgw.Node(ctx, children)
		_gsxgw.S("</a>")
		return _gsxgw.Err()
	})
...
//line navigation-menu.gsx:286:1
...
//line navigation-menu.gsx:313:1
func NavigationMenuIndicator(attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
//line navigation-menu.gsx:314:2
		_gsxgw.S("<div class=\"")
		...
		_gsxgw.S(">")
//line navigation-menu.gsx:322:3
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("bg-border rounded-ss-sm shadow-md relative top-[60%] h-2 w-2 rotate-45"))
		_gsxgw.S("\"")
