...
//line select.gsx:99:2
		_gsxgw.S("<span class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("items-center line-clamp-1"), _gsxrt.Class("flex gap-1.5 flex-1 text-start"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
