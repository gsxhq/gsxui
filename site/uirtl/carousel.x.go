...
//line carousel.gsx:142:2
		...
		_gsxv2 := "absolute size-8 rounded-full touch-manipulation"
		var _gsxv3 string
		switch orientation {
		case "vertical":
			_gsxv3 = "-top-12 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 rotate-90"
		default:
...
//line carousel.gsx:167:2
		...
		_gsxv6 := "absolute size-8 rounded-full touch-manipulation"
		var _gsxv7 string
		switch orientation {
		case "vertical":
			_gsxv7 = "-bottom-12 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 rotate-90"
		default:
