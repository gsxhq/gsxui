...
//line table.gsx:45:2
		_gsxgw.S("<th class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-foreground h-10 px-2 text-start align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pe-0"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line table.gsx:57:2
		_gsxgw.S("<td class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pe-0"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
