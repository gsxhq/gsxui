...
- Name: jstest/specs/menus-style-contract.spec.ts >> checked menu and combobox indicators follow semantic owner state
- Location: jstest/specs/menus-style-contract.spec.ts:33:1
