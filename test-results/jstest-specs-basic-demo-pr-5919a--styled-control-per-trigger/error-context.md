...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> dropdown-menu/radios presents one styled control per trigger
...
Call log:
  - navigating to "/x/dropdown-menu/radios", waiting until "load"
