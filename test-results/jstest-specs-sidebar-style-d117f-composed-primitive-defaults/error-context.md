...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> caller utility layer wins over sidebar and composed primitive defaults
- Location: jstest/specs/sidebar-style-contract.spec.ts:275:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=caller", waiting until "load"
