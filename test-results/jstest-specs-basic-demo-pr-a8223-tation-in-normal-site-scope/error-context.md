...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> Button variants and sizes keep Nova presentation in normal site scope
- Location: jstest/specs/basic-demo-presentation.spec.ts:143:1
...
Call log:
  - navigating to "/x/button/variants", waiting until "load"
