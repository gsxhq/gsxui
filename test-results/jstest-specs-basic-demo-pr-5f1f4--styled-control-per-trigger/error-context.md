...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> tooltip/basic presents one styled control per trigger
...
Call log:
  - navigating to "/x/tooltip/basic", waiting until "load"
