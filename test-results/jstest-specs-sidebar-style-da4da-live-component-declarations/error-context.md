...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> all eight sidebar theme tokens feed live component declarations
- Location: jstest/specs/sidebar-style-contract.spec.ts:237:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=tokens", waiting until "load"
