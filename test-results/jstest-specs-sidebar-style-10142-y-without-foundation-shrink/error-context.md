...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> custom style owns floating and inset collapsed density without foundation shrink
- Location: jstest/specs/sidebar-style-contract.spec.ts:358:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=icon-floating", waiting until "load"
