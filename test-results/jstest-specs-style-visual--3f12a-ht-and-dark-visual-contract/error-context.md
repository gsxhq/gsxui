...
- Name: jstest/specs/style-visual.spec.ts >> checkbox/states keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/checkbox/states", waiting until "load"
