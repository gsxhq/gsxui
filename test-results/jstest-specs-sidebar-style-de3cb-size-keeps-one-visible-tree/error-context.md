...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> mobile trigger opens the native Sheet tree and desktop resize keeps one visible tree
- Location: jstest/specs/sidebar-style-contract.spec.ts:294:1
