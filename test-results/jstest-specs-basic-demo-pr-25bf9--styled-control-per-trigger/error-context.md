...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> drawer/directions presents one styled control per trigger
...
Call log:
  - navigating to "/x/drawer/directions", waiting until "load"
