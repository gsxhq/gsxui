...
- Name: jstest/specs/style-visual.spec.ts >> navigation-menu/mega keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/navigation-menu/mega", waiting until "load"
