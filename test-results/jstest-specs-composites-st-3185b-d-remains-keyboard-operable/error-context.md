...
- Name: jstest/specs/composites-style-contract.spec.ts >> Resizable consumes dynamic flex values and remains keyboard operable
- Location: jstest/specs/composites-style-contract.spec.ts:199:1
...
Call log:
  - navigating to "/x/resizable/handle", waiting until "load"
