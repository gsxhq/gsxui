...
- Name: jstest/specs/composites-style-contract.spec.ts >> horizontal ButtonGroup separators stay on the cross-axis
- Location: jstest/specs/composites-style-contract.spec.ts:30:1
...
Call log:
  - navigating to "/x/button-group/basic", waiting until "load"
