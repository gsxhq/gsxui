...
- Name: jstest/specs/foundation-contract.spec.ts >> foundation keeps Resizable keyboard and pointer geometry at 900px
- Location: jstest/specs/foundation-contract.spec.ts:76:3
...
Call log:
  - navigating to "/x/resizable/handle?css=foundation", waiting until "load"
