...
- Name: jstest/specs/foundation-contract.spec.ts >> foundation keeps Carousel navigation geometrically functional
- Location: jstest/specs/foundation-contract.spec.ts:51:1
...
Call log:
  - navigating to "/x/carousel/basic?css=foundation", waiting until "load"
