...
- Name: jstest/specs/style-visual.spec.ts >> Carousel arrows stay circular over Button's own radius
- Location: jstest/specs/style-visual.spec.ts:704:1
...
Call log:
  - navigating to "/x/carousel/basic", waiting until "load"
