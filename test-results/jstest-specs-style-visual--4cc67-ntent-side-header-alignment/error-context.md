...
- Name: jstest/specs/style-visual.spec.ts >> bottom Drawer uses Dialog mechanics and content-side header alignment
- Location: jstest/specs/style-visual.spec.ts:386:1
