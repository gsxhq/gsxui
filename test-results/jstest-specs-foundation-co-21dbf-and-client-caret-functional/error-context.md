...
- Name: jstest/specs/foundation-contract.spec.ts >> foundation keeps InputOTP entry and client caret functional
- Location: jstest/specs/foundation-contract.spec.ts:116:1
...
Call log:
  - navigating to "/x/input-otp/basic?css=foundation", waiting until "load"
