...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> menu item relations reserve action space and align action/badge by button size
- Location: jstest/specs/sidebar-style-contract.spec.ts:201:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=menu-expanded", waiting until "load"
