...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> dialog/footer presents one styled control per trigger
...
Call log:
  - navigating to "/x/dialog/footer", waiting until "load"
