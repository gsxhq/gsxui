...
- Name: jstest/specs/theme-editor.spec.ts >> touch pointerenter does not preview on a fine hover-capable device
- Location: jstest/specs/theme-editor.spec.ts:309:1
