...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> Button fallback cannot style a theme-preview body
- Location: jstest/specs/basic-demo-presentation.spec.ts:181:1
...
Call log:
  - navigating to "/x/pagination/basic", waiting until "load"
