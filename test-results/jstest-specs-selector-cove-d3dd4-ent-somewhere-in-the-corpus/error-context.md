...
- Name: jstest/specs/selector-coverage.spec.ts >> every recorded selector matches an element somewhere in the corpus
- Location: jstest/specs/selector-coverage.spec.ts:83:1
