...
- Name: jstest/specs/theme-editor.spec.ts >> desktop hover previews only the iframe and restores on dismissal or pointer leave
- Location: jstest/specs/theme-editor.spec.ts:257:1
