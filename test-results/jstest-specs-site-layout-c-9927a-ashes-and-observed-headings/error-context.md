...
- Name: jstest/specs/site-layout.spec.ts >> component table of contents follows existing hashes and observed headings
- Location: jstest/specs/site-layout.spec.ts:70:1
...
Call log:
  - navigating to "/components/button#example-variants", waiting until "load"
