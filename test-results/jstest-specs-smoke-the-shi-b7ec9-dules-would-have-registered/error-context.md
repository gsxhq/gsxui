...
- Name: jstest/specs/smoke.spec.ts >> the shim records what the real modules would have registered
- Location: jstest/specs/smoke.spec.ts:35:1
...
Call log:
  - navigating to "/registrations", waiting until "load"
