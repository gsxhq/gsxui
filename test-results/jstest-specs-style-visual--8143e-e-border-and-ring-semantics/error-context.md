...
- Name: jstest/specs/style-visual.spec.ts >> an active invalid InputOTP slot keeps destructive border and ring semantics
- Location: jstest/specs/style-visual.spec.ts:227:1
