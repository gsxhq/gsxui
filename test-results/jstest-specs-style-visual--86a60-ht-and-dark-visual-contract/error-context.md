...
- Name: jstest/specs/style-visual.spec.ts >> sidebar/variants?_preview=icon-collapsed keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/sidebar/variants?_preview=icon-collapsed", waiting until "load"
