...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> mobile rail stays non-interactive through the sm breakpoint and only the md tree operates
- Location: jstest/specs/sidebar-style-contract.spec.ts:316:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=mobile", waiting until "load"
