...
- Name: jstest/specs/style-visual.spec.ts >> mobile visual contracts >> sidebar/variants keeps its mobile visual contract
- Location: jstest/specs/style-visual.spec.ts:684:5
...
Call log:
  - navigating to "/x/sidebar/variants", waiting until "load"
