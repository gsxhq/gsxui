...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> dropdown-menu/destructive presents one styled control per trigger
...
Call log:
  - navigating to "/x/dropdown-menu/destructive", waiting until "load"
