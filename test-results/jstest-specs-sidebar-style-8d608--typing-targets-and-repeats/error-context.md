...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> keyboard shortcut uses the first wrapper, ignores typing targets and repeats
- Location: jstest/specs/sidebar-style-contract.spec.ts:434:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=keyboard", waiting until "load"
