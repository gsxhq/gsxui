...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> right offcanvas and icon/floating/inset geometry follow explicit axes
- Location: jstest/specs/sidebar-style-contract.spec.ts:90:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=offcanvas-right", waiting until "load"
