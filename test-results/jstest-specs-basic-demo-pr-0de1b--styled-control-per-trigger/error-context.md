...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> dropdown-menu/basic presents one styled control per trigger
...
Call log:
  - navigating to "/x/dropdown-menu/basic", waiting until "load"
