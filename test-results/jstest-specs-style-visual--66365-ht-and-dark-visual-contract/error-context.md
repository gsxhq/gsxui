...
- Name: jstest/specs/style-visual.spec.ts >> alert/variants keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/alert/variants", waiting until "load"
