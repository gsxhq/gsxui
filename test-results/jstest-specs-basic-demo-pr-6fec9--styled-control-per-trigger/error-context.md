...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> popover/basic presents one styled control per trigger
...
Call log:
  - navigating to "/x/popover/basic", waiting until "load"
