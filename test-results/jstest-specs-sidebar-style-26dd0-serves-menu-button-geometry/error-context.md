...
- Name: jstest/specs/sidebar-style-contract.spec.ts >> icon collapse hides labelled branches and preserves menu button geometry
- Location: jstest/specs/sidebar-style-contract.spec.ts:162:1
...
Call log:
  - navigating to "/f/sidebar-contract?case=menu-icon", waiting until "load"
