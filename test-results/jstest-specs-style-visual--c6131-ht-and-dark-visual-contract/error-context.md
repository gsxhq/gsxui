...
- Name: jstest/specs/style-visual.spec.ts >> sidebar/variants?_preview=icon keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/sidebar/variants?_preview=icon", waiting until "load"
