...
- Name: jstest/specs/foundation-contract.spec.ts >> full style leaves caller utilities later in the cascade
- Location: jstest/specs/foundation-contract.spec.ts:176:1
