...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> combobox/basic does not render a disconnected value label
- Location: jstest/specs/basic-demo-presentation.spec.ts:129:1
...
Call log:
  - navigating to "/x/combobox/basic", waiting until "load"
