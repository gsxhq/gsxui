...
- Name: jstest/specs/style-visual.spec.ts >> sidebar/variants?_preview=floating keeps its desktop light and dark visual contract
...
Call log:
  - navigating to "/x/sidebar/variants?_preview=floating", waiting until "load"
