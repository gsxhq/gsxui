...
- Name: jstest/specs/basic-demo-presentation.spec.ts >> dropdown-menu/submenu presents one styled control per trigger
...
Call log:
  - navigating to "/x/dropdown-menu/submenu", waiting until "load"
