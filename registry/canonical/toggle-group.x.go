...
//line toggle-group.gsx:75:2
		...
		_gsxgw.S(" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/toggle-group"), _gsxrt.Class(toggleGroup.Root()), _gsxrt.Class(toggleGroup.Size(size)), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
