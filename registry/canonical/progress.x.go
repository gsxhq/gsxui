...
//line progress.gsx:44:2
		...
		_gsxgw.S(" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("relative flex w-full items-center overflow-x-hidden"), _gsxrt.Class(progress.Root()), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
...
//line progress.gsx:53:3
		...
		_gsxgw.S("%)\" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("size-full flex-1 transition-all"), _gsxrt.Class(progress.Indicator()))
		_gsxgw.S("\"")
