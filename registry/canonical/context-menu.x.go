...
//line context-menu.gsx:107:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/context-menu-item"), _gsxrt.Class(contextMenu.Item()), _gsxrt.Class(contextMenu.ItemVariant(variant)), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
