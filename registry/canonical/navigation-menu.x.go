...
//line navigation-menu.gsx:240:2
		...
		_gsxgw.S(">")
//line navigation-menu.gsx:254:3
		_gsxgw.Node(ctx, children)
		_gsxgw.S("</a>")
		return _gsxgw.Err()
	})
...
//line navigation-menu.gsx:258:1
...
//line navigation-menu.gsx:285:1
func NavigationMenuIndicator(attrs gsx.Attrs) _gsxrt.Node {
	return _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
//line navigation-menu.gsx:286:2
		_gsxgw.S("<div class=\"")
		...
		_gsxgw.S(">")
//line navigation-menu.gsx:292:3
		_gsxgw.S("<div class=\"")
