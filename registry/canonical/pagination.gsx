...
component PaginationPrevious(href string, attrs gsx.Attrs) {
	...
	>
		...
		<span class={ pagination.PreviousLabel() } data-gsxui-slot-pagination-previous-label>{ i18n.T("Previous") }</span>
	</PaginationLink>
}
...
component PaginationNext(href string, attrs gsx.Attrs) {
	...
	>
		<span class={ pagination.NextLabel() } data-gsxui-slot-pagination-next-label>{ i18n.T("Next") }</span>
