...
//line aspect-ratio.gsx:85:2
		...
		_gsxv7 := _gsxv6
		_gsxv8 := _gsxrt.ConcatAttrs(_gsxv7, _gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(aspectRatio.Root()))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-aspect-ratio", Value: _gsxrt.Toggle(true)}})
		_gsxgw.S("<div")
