...
//line item.gsx:46:2
		...
		_gsxgw.S(" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/item"), _gsxrt.Class(item.Root()), _gsxrt.Class(item.Variant(variant)), _gsxrt.Class(item.Size(size)), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
