...
//line combobox.gsx:177:3
			_gsxgw.NodeResult(_gsxrenderInputGroupAddon(ctx, _gsxgw, "inline-end", _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
				_gsxgw := _gsxrt.W(_gsxw)
//line combobox.gsx:178:4
				if showTrigger {
//line combobox.gsx:179:5
...
//line combobox.gsx:186:6
						...
						return _gsxgw.Err()
					}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "disabled", Value: disabled}}, _gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(combobox.Trigger()))}}, _gsxrt.Attrs{{Key: "data-gsxui-slot-combobox-trigger", Value: _gsxrt.Toggle(true)}})))
				}
...
//line combobox.gsx:193:3
			_gsxgw.Node(ctx, children)
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(combobox.InputGroup()))}}, wrapperAttrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-combobox-input-group", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}
...
//line combobox.gsx:234:2
	_gsxgw.NodeResult(_gsxrenderInputGroupButton(ctx, _gsxgw, "ghost", "icon-xs", _gsxrt.Func(func(ctx _gsxctx.Context, _gsxw _gsxio.Writer) error {
		_gsxgw := _gsxrt.W(_gsxw)
//line combobox.gsx:241:3
		_gsxgw.Node(ctx, icon.X())
		return _gsxgw.Err()
	}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class(combobox.Clear()))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-combobox-clear", Value: _gsxrt.Toggle(true)}})))
	return _gsxgw.Err()
}

//line combobox.gsx:245:1
