...
component BreadcrumbList(children gsx.Node, attrs gsx.Attrs) {
	<ol class={ breadcrumb.List() } { attrs... } data-gsxui-slot-breadcrumb-list>
		{ children }
	</ol>
}

component BreadcrumbItem(children gsx.Node, attrs gsx.Attrs) {
	<li class={ breadcrumb.Item() } { attrs... } data-gsxui-slot-breadcrumb-item>
		{ children }
	</li>
}
...
component BreadcrumbLink(href string, children gsx.Node, attrs gsx.Attrs) {
	<a href={href} class={ breadcrumb.Link() } { attrs... } data-gsxui-slot-breadcrumb-link>
		{ children }
	</a>
}
