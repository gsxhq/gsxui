...
component SheetHeader(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "gap-0.5 p-4 flex flex-col" } { attrs... } data-gsxui-slot-sheet-header>{ children }</div>
}
