...
//line field.gsx:110:3
			_gsxgw.Node(ctx, children)
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class("group/field-label"), _gsxrt.Class("has-[input:checked]:bg-primary/5 has-[input:checked]:border-primary/30 dark:has-[input:checked]:border-primary/20 dark:has-[input:checked]:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-none has-[>[data-gsxui-slot-field]]:border has-[>[data-gsxui-slot-field]]:not-has-[:disabled,[data-disabled]]:hover:bg-muted/50 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:border-ring has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-ring/50 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-1 flex w-fit has-[>[data-gsxui-slot-field]]:w-full has-[>[data-gsxui-slot-field]]:flex-col [&>[data-gsxui-slot-field]]:p-2"))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-field-label", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}
...
//line field.gsx:117:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed flex w-fit items-center"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:127:2
		_gsxgw.S("<p class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground text-left text-xs/relaxed [[data-variant=legend]+&]:-mt-1.5 leading-normal font-normal [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:144:2
		...
		_gsxgw.S(" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("-my-2 h-5 text-xs group-data-[variant=outline]/field-group:-mb-2 relative"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:167:3
			...
			_gsxgw.S(" class=\"")
			_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-destructive text-xs"), _gsxrt.Class(attrs.Class()))
			_gsxgw.S("\"")
			_gsxgw.StyleMerged("", attrs.Style())
