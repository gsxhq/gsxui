...
//line input-group.gsx:44:2
	...
	_gsxv0 := "text-muted-foreground h-auto gap-2 py-1.5 text-xs font-medium group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-none [&>svg:not([class*='size-'])]:size-4 flex"
	var _gsxv1 string
	switch align {
	case "inline-end":
...
//line input-group.gsx:84:2
		_gsxgw.S("<span class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-muted-foreground gap-2 text-xs [&_svg:not([class*='size-'])]:size-4 flex"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
