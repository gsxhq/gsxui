...
component CommandInput(placeholder string, attrs gsx.Attrs) {
	<div
		class={
			"p-1 bg-input/30 border-input/30 h-8 rounded-lg shadow-none [&>[data-gsxui-slot-input-group-addon]]:pl-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:opacity-50 flex items-center gap-2"
		}
