...
//line toggle.gsx:59:2
		...
		switch size {
		case "sm":
			_gsxv2 = "h-8 min-w-8 px-2.5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5"
		case "lg":
			_gsxv2 = "h-10 min-w-10 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2"
		default:
