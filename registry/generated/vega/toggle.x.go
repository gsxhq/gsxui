...
//line toggle.gsx:60:2
		...
		switch variant {
		case "outline":
			_gsxv1 = "border-input hover:bg-muted border bg-transparent shadow-xs"
		default:
		...
		switch size {
		case "sm":
			_gsxv2 = "h-8 min-w-8 px-2.5 has-[>svg]:px-1.5"
		case "lg":
			_gsxv2 = "h-10 min-w-10 px-2.5 has-[>svg]:px-2"
		default:
