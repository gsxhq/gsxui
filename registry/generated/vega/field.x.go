...
//line field.gsx:46:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-7 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:58:2
		...
		_gsxv2 := "data-[invalid=true]:text-destructive gap-3 p-3 flex"
		var _gsxv3 string
		switch orientation {
		case "horizontal":
