...
//line toggle-group.gsx:120:2
		...
		switch size {
		case "sm":
			_gsxv4 = "h-8 min-w-8 px-2.5 has-[>svg]:px-1.5 group-data-[spacing=0]/toggle-group:has-[>svg]:px-1.5"
		case "lg":
			_gsxv4 = "h-10 min-w-10 px-2.5 has-[>svg]:px-2 group-data-[spacing=0]/toggle-group:has-[>svg]:px-2"
		default:
