...
component FieldLegend(variant string, children gsx.Node, attrs gsx.Attrs) {
	<legend
		...
		class={ "mb-3 font-medium", switch variant { case "label": "text-sm" default: "text-base" } }
		{ attrs... }
...
component FieldGroup(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={
			"group/field-group", "gap-7 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col w-full @container/field-group"
		}
		{ attrs... }
...
component Field(orientation string, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={
			"group/field",
			"data-[invalid=true]:text-destructive gap-3 p-3 flex w-full",
			switch orientation {
			case "horizontal":
...
component FieldLabel(children gsx.Node, attrs gsx.Attrs) {
	<Label
		class={
			"group/field-label",
			"has-[input:checked]:bg-primary/5 has-[input:checked]:border-primary/30 dark:has-[input:checked]:border-primary/20 dark:has-[input:checked]:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border has-[>[data-gsxui-slot-field]]:not-has-[:disabled,[data-disabled]]:hover:bg-muted/50 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:border-ring has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-ring/50 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-3 flex w-fit has-[>[data-gsxui-slot-field]]:w-full has-[>[data-gsxui-slot-field]]:flex-col [&>[data-gsxui-slot-field]]:p-2"
		}
		{ attrs... }
