...
component SheetHeader(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "gap-1.5 p-4 flex flex-col" } { attrs... } data-gsxui-slot-sheet-header>{ children }</div>
}
...
component SheetTitle(children gsx.Node, attrs gsx.Attrs) {
	<h2 class={ "text-foreground font-medium" } { attrs... } data-gsxui-slot-sheet-title data-gsxui-slot-dialog-title>
		{ children }
	</h2>
}
