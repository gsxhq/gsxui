...
//line button-group.gsx:34:2
		...
		_gsxv0 := "[&>[data-gsxui-slot-input]]:px-4 has-[>[data-variant=outline]]:[&>input]:border-border has-[>[data-variant=outline]]:[&>input:focus-visible]:border-ring has-[>[data-variant=outline]]:*:[data-gsxui-slot-input-group]:border-border has-[>[data-variant=outline]]:[&>[data-gsxui-slot-input-group]:has(:focus-visible)]:border-ring has-[>[data-variant=outline]]:*:[data-gsxui-slot-select-trigger]:border-border has-[>[data-variant=outline]]:*:[data-gsxui-slot-input-group]:px-2.5 has-[>[data-variant=outline]]:*:[[role=combobox]]:px-2.5 flex"
		var _gsxv1 string
		switch orientation {
		case "vertical":
