...
//line empty.gsx:10:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 border-dashed p-12 flex flex-col"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
...
//line empty.gsx:56:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-sm/relaxed mt-0.5"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
