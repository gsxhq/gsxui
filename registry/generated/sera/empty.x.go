...
//line empty.gsx:10:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 border-dashed p-12 flex flex-col w-full min-w-0 flex-1 items-center justify-center text-center text-balance"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
...
//line empty.gsx:32:2
		...
		switch variant {
		case "icon":
			_gsxv1 = "bg-muted text-foreground flex size-10 shrink-0 items-center justify-center rounded-none [&_svg:not([class*='size-'])]:size-5"
		default:
...
//line empty.gsx:62:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-sm/relaxed mt-0.5 text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line empty.gsx:74:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 text-sm flex flex-col w-full max-w-sm min-w-0 items-center text-balance"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
