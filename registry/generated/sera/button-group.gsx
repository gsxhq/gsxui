...
component ButtonGroup(orientation string, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={
			"[&>[data-gsxui-slot-input]]:px-4 has-[>[data-variant=outline]]:[&>input]:border-border has-[>[data-variant=outline]]:[&>input:focus-visible]:border-ring has-[>[data-variant=outline]]:*:[data-gsxui-slot-input-group]:border-border has-[>[data-variant=outline]]:[&>[data-gsxui-slot-input-group]:has(:focus-visible)]:border-ring has-[>[data-variant=outline]]:*:[data-gsxui-slot-select-trigger]:border-border has-[>[data-variant=outline]]:*:[data-gsxui-slot-input-group]:px-2.5 has-[>[data-variant=outline]]:*:[[role=combobox]]:px-2.5 flex",
			switch orientation {
			case "vertical":
...
component ButtonGroupText(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={
			"gap-2 border border-transparent border-b-input bg-transparent px-2.5 text-xs font-semibold [&_svg:not([class*='size-'])]:size-3.5 group-has-[>[data-variant=outline]]/button-group:border-border uppercase flex"
		}
		{ attrs... }
