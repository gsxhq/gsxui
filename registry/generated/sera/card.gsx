...
component CardHeader(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={
			"gap-1.5 rounded-none px-(--card-spacing) [.border-b]:pb-(--card-spacing) grid auto-rows-min grid-rows-[auto_auto]"
		}
		{ attrs... }
...
component CardFooter(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "px-(--card-spacing) [.border-t]:pt-(--card-spacing) flex" } { attrs... } data-gsxui-slot-card-footer>
		{ children }
	</div>
}
