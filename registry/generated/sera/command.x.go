...
//line command.gsx:26:2
	_gsxgw.S("<div class=\"")
	_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("bg-popover text-popover-foreground flex flex-col"), _gsxrt.Class(attrs.Class()))
	_gsxgw.S("\"")
