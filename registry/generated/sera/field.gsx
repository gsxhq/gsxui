...
component FieldLegend(variant string, children gsx.Node, attrs gsx.Attrs) {
	<legend
		...
		class={ "mb-3 font-semibold uppercase", switch variant { case "label": "text-xs" default: "text-xs" } }
		{ attrs... }
...
component FieldLabel(children gsx.Node, attrs gsx.Attrs) {
	<Label
		class={
			"group/field-label",
			"has-[input:checked]:bg-primary/5 has-[input:checked]:border-primary/30 dark:has-[input:checked]:border-primary/20 dark:has-[input:checked]:bg-primary/10 gap-2 has-[>[data-gsxui-slot-field]]:rounded-none has-[>[data-gsxui-slot-field]]:border has-[>[data-gsxui-slot-field]]:not-has-[:disabled,[data-disabled]]:hover:bg-muted/50 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-ring/30 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-2 leading-relaxed flex w-fit has-[>[data-gsxui-slot-field]]:w-full has-[>[data-gsxui-slot-field]]:flex-col [&>[data-gsxui-slot-field]]:p-4"
		}
		{ attrs... }
