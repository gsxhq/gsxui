...
component ComboboxItem(value string, selected bool, children gsx.Node, attrs gsx.Attrs) {
	<div
		...
		class={
			...
			"data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium [&_svg:not([class*='size-'])]:size-4 flex data-[state=checked]:[&>[data-gsxui-slot-combobox-item-indicator]]:flex"
		}
		{ attrs... }
...
component ComboboxLabel(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "text-muted-foreground px-3 py-2.5 text-xs" } { attrs... } data-gsxui-slot-combobox-label>
		{ children }
	</div>
}
...
component ComboboxSeparator(attrs gsx.Attrs) {
	<div
		aria-hidden="true"
		class={ "bg-border -mx-1.5 my-1.5 h-px" }
		{ attrs... }
