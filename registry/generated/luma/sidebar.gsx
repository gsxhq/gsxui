...
component SidebarGroupLabel(children gsx.Node, attrs gsx.Attrs) {
	<div
		class={
			"text-sidebar-foreground/70 ring-sidebar-ring h-8 rounded-xl px-3 text-xs font-medium transition-[margin,opacity] duration-200 ease-linear [[data-gsxui-slot-sidebar-desktop][data-collapsible=icon]_&]:-mt-8 [[data-gsxui-slot-sidebar-desktop][data-collapsible=icon]_&]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 flex"
		}
		{ attrs... }
...
component SidebarGroupAction(children gsx.Node, attrs gsx.Attrs) {
	<button
		class={
			"text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-3.5 end-3 [[data-gsxui-slot-sidebar-desktop][data-collapsible=icon]_&]:hidden w-5 rounded-xl p-0 focus-visible:ring-2 [&>svg]:size-4 flex"
		}
		type="button"
		{ attrs... }
