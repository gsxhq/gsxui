...
component Radio(attrs gsx.Attrs) {
	<input
		type="radio"
		class={
			"bg-input/90 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary border-transparent aria-invalid:border-destructive focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 dark:aria-invalid:border-destructive/50 flex size-4 rounded-full border focus-visible:ring-3 aria-invalid:ring-3 group-has-[:focus-visible]/field-label:ring-0 group-has-[:focus-visible]/field-label:border-transparent shrink-0 outline-none disabled:cursor-not-allowed disabled:opacity-50"
		}
		{ attrs... }
