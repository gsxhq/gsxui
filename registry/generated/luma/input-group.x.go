...
//line input-group.gsx:44:2
	...
	_gsxv0 := "text-muted-foreground [&_[data-gsxui-slot-kbd]]:bg-muted-foreground/10 h-auto gap-2 py-2 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 [&_[data-gsxui-slot-kbd]]:rounded-3xl [&_[data-gsxui-slot-kbd]]:px-1.5 [&>svg:not([class*='size-'])]:size-4 flex"
	var _gsxv1 string
	switch align {
	case "inline-end":
		_gsxv1 = "pr-3 has-[>button]:-mr-1 has-[>kbd]:-mr-1"
	case "block-start":
		_gsxv1 = "px-3 pt-3 group-has-[>input]/input-group:pt-3.5 [.border-b]:pb-3.5"
	case "block-end":
		_gsxv1 = "px-3 pb-3 group-has-[>input]/input-group:pb-3.5 [.border-t]:pt-3.5"
	default:
		_gsxv1 = "pl-3 has-[>button]:-ml-1 has-[>kbd]:-ml-1"
	}
	_gsxgw.S(" class=\"")
