...
//line navigation-menu.gsx:254:2
		_gsxgw.S("<a")
		_gsxv0 := "focus-visible:ring-ring/30 hover:bg-muted focus:bg-muted flex items-center gap-1.5 rounded-3xl p-3 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 [[data-gsxui-slot-navigation-menu-content]_&]:rounded-2xl"
		var _gsxv1 string
		switch linkVariant {
		case "trigger":
