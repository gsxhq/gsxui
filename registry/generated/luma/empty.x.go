...
//line empty.gsx:10:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 rounded-2xl border-dashed p-12 flex flex-col w-full min-w-0 flex-1 items-center justify-center text-center text-balance"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
