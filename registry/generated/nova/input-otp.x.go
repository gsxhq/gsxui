...
//line input-otp.gsx:143:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-lg has-aria-invalid:ring-3 flex items-center"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		if !attrs.Has("dir") {
			_gsxgw.S(" dir=\"ltr\"")
		}
