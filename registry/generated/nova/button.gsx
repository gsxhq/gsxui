	...
	{ if href != "" && !disabled {
		<a
			...
			class={
				...
				switch variant {
				case "destructive":
					"bg-destructive text-contrast hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:bg-destructive/60 dark:hover:bg-destructive/90 dark:focus-visible:ring-destructive/40"
				case "outline":
