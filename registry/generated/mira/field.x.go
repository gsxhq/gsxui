...
//line field.gsx:35:2
		...
		_gsxv0 := "mb-2 font-medium"
		var _gsxv1 string
		switch variant {
		case "label":
			_gsxv1 = "text-xs/relaxed"
		default:
			_gsxv1 = "text-sm"
		}
		_gsxgw.S(" class=\"")
...
//line field.gsx:46:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("group/field-group"), _gsxrt.Class("gap-4 [&>[data-gsxui-slot-field-group]]:gap-4 flex flex-col w-full @container/field-group"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:110:3
			_gsxgw.Node(ctx, children)
			return _gsxgw.Err()
		}), _gsxrt.ConcatAttrs(_gsxrt.Attrs{{Key: "class", Value: _gsxrt.ClassJoin(_gsxrt.Class("group/field-label"), _gsxrt.Class("has-[input:checked]:bg-primary/5 dark:has-[input:checked]:bg-primary/10 gap-2 leading-snug has-[>[data-gsxui-slot-field]]:rounded-md has-[>[data-gsxui-slot-field]]:border has-[>[data-gsxui-slot-field]]:not-has-[:disabled,[data-disabled]]:hover:bg-input/40 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:border-ring has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-ring/30 has-[>[data-gsxui-slot-field]]:has-[:focus-visible]:ring-2 flex w-fit has-[>[data-gsxui-slot-field]]:w-full has-[>[data-gsxui-slot-field]]:flex-col [&>[data-gsxui-slot-field]]:p-2"))}}, attrs, _gsxrt.Attrs{{Key: "data-gsxui-slot-field-label", Value: _gsxrt.Toggle(true)}})))
		return _gsxgw.Err()
	})
}
...
//line field.gsx:117:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed font-medium flex w-fit items-center"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:144:2
		...
		_gsxgw.S(" class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("-my-2 h-5 text-xs/relaxed group-data-[variant=outline]/field-group:-mb-2 relative"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
...
//line field.gsx:167:3
			...
			_gsxgw.S(" class=\"")
			_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("text-destructive text-xs/relaxed"), _gsxrt.Class(attrs.Class()))
			_gsxgw.S("\"")
			_gsxgw.StyleMerged("", attrs.Style())
