...
//line empty.gsx:10:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-4 rounded-xl border-dashed p-6 flex flex-col"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
...
//line empty.gsx:62:2
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("gap-2 text-xs/relaxed flex flex-col"), _gsxrt.Class(attrs.Class()))
		_gsxgw.S("\"")
		_gsxgw.StyleMerged("", attrs.Style())
