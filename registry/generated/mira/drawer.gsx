...
component DrawerHeader(children gsx.Node, attrs gsx.Attrs) {
	<div class={ "gap-1 p-4 md:text-left flex flex-col" } { attrs... } data-gsxui-slot-drawer-header>{ children }</div>
}
