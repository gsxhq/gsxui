...
//line toggle.gsx:59:2
		...
		_gsxv0 := "hover:text-foreground aria-pressed:bg-muted focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive gap-1 rounded-2xl text-sm font-medium transition-colors [&_svg:not([class*='size-'])]:size-4 inline-flex"
		var _gsxv1 string
		switch variant {
		case "outline":
		...
		switch size {
		case "sm":
			_gsxv2 = "h-7 min-w-7 px-2.5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5"
		case "lg":
