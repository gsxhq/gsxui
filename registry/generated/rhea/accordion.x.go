...
//line accordion.gsx:47:2
		...
		_gsxgw.S("<div class=\"")
		_gsxgw.Class(_gsxcm.Merge, _gsxrt.Class("data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up px-4 text-sm"), _gsxrt.Class(_gsxv0.Class()))
		_gsxgw.S("\"")
