...
//line toggle-group.gsx:75:2
		...
		_gsxv1 := "data-[spacing=0]:data-[variant=outline]:rounded-2xl flex w-fit items-center gap-[--spacing(var(--gap))]"
		var _gsxv2 string
		switch size {
		case "sm":
...
//line toggle-group.gsx:120:2
		...
		switch size {
		case "sm":
			_gsxv4 = "h-7 min-w-7 px-2.5 has-[>svg]:px-1.5 group-data-[spacing=0]/toggle-group:has-[>svg]:px-1.5"
		case "lg":
